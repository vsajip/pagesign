# -*- coding: utf-8 -*-
#
# pagesign for Python documentation build configuration file.
#
...
project = u'pagesign'
copyright = u'2021-%s, Vinay Sajip' %  datetime.date.today().year
...
from pagesign import __version__ as release, __date__ as today
...
htmlhelp_basename = 'AgeMinisignWrapperforPythondoc'
...
latex_documents = [
  ('index', 'AgeMinisignWrapperforPython.tex', u'Age/Minisign Wrapper for Python Documentation',
...
man_pages = [
    ('index', 'pagesign', u'pagesign Documentation',
     [u'Vinay Sajip'], 1)
]
...
epub_title = u'pagesign'
epub_author = u'Vinay Sajip'
epub_publisher = u'Vinay Sajip'
epub_copyright = u'2021, Vinay Sajip'
